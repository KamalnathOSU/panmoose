...
class GmTernaryExtendedNegative : public DerivativeMaterialInterface<Material>
{
public:
  static InputParameters validParams();
  GmTernaryExtendedNegative(const InputParameters & parameters);
  ~GmTernaryExtendedNegative();
